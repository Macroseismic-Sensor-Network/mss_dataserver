# -*- coding: utf-8 -*-
#
# pSysmon documentation build configuration file, created by
...
modindex_common_prefix = ['mss_dataserver.']
...
latex_documents = [
  ('index', 'pSysmon.tex', 'mss_dataserver Documentation',
   'Stefan Mertl', 'manual'),
]
...
man_pages = [
    ('index', 'psysmon', u'mss_dataserver Documentation',
     ['Stefan Mertl'], 1)
]
